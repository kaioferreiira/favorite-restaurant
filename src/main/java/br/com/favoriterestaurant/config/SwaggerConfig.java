package br.com.favoriterestaurant.config;
    ...
    */
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.favoriterestaurant.api"))
    ...
    private ApiInfo apiInfo(){
        return new ApiInfo(
                "Gestão de votos",
                "API utilizada para o gerenciamento de votos",
                "Versão 1.0.0-RELEASE",
                "",
                new Contact("Kaio Ferreira", "https://github.com/kaioferreiira",
                        ""),
                "Permitido somente uso interno",
                "https://www.kaioferreira.blog.br",
    ...
    private ResponseMessage customMessage201() {
        ...
        map.put("version", new Header("version", "api-version: 2020-01-01", new ModelRef("string")));
